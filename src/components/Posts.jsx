  ...
  return (
    <div className="flex flex-col border-y-[1px] py-3 mt-4">
      <div className='flex items-center justify-between gap-3'>
        ...
        <button className="flex gap-1 items-center hover:text-cyan-600 hover:bg-cyan-200 rounded-full p-2">
      ...
      <div className='flex flex-col mt-2'>
        <img 
          ...
          <div className="flex items-center justify-between mt-3">
            <div>
              <button className="flex gap-1 items-center hover:text-red-600 hover:bg-red-300 rounded-2xl p-2">
            ...
            <div className="flex gap-6">
              <button className="flex gap-1 items-center hover:text-green-600 hover:bg-green-300 rounded-full p-2">
                <RiMessage2Line className="text-lg"/>
              </button>

              <button className="flex gap-1 items-center hover:text-blue-600 hover:bg-blue-300 rounded-full p-2">
